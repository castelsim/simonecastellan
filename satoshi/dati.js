...
const TRACCE = [
  ...
  { id: 'lavoro', corto: 'Lavoro', nome: 'Il lavoro che costa',  sintesi: 'Rendere il falso costoso: è la prova di lavoro.' },
  { id: 'codice', corto: 'Codice', nome: 'Il codice come politica', sintesi: 'Chi scrive software decide chi può parlare in privato.' }
];
...
const NODI = [
  ...
  },
  {
    ...
    fonte: { testo: 'La tesi di Merkle (PDF)', url: 'https://www.ralphmerkle.com/papers/Thesis1979.pdf' }
  },
  ...
  /* ── traccia: la moneta anonima ──────────────────────────────────── */
  {
    ...
    testo: 'Chaum inventa un modo per farsi firmare un documento da una banca senza che la banca possa leggerlo. Tradotto in denaro: la banca certifica che quella moneta è valida, ma non saprà mai dove finirà spesa. È il primo progetto serio di contante digitale, e nasce ventisei anni prima di Bitcoin.',
  ...
  },
  {
    ...
    titolo: 'DigiCash, e un centro di troppo', chi: 'David Chaum, Amsterdam',
  ...
  /* ── traccia: la marca temporale ─────────────────────────────────── */
  {
    ...
    fonte: { testo: 'How to time-stamp a digital document', url: 'https://link.springer.com/article/10.1007/BF00196791' }
  },
  ...
  },
  {
    ...
    fonte: { testo: 'Cronologia della crisi', url: 'https://www.federalreservehistory.org/essays/support-for-specific-institutions' }
  },
  {
    ...
    testo: 'Un file si copia. Se il denaro è un file, chi paga può spendere due volte la stessa moneta mandandola a due persone diverse nello stesso istante. Una banca risolve la questione tenendo lei l’unico registro valido. Senza banca servirebbe che migliaia di copie dello stesso registro, aggiornate da sconosciuti che non si fidano fra loro, arrivassero da sole alla stessa versione della storia. Per trent’anni nessuno c’era riuscito.',
    perche: 'Tutte e cinque le strade si fermano qui. Il white paper si apre esattamente su questo punto.',
    fonte: { testo: 'Il problema della doppia spesa', url: 'https://en.wikipedia.org/wiki/Double-spending' }
  },
  {
    id: 'whitepaper', breve: 'Il white paper', anno: 2008, data: '31 ottobre 2008, 18:10 UTC', traccia: 'tronco', tipo: 'evento', cardine: true,
    titolo: 'Nove pagine su una mailing list', chi: 'Satoshi Nakamoto',
    testo: 'Un messaggio a una lista di crittografia frequentata da poche centinaia di persone annuncia un documento intitolato «Bitcoin: un sistema di contante elettronico da utente a utente». In nove pagine le cinque strade si chiudono in un progetto solo: firme digitali, catena di marche temporali, prova di lavoro, e una regola per decidere quale versione del registro vale — quella su cui è stato speso più lavoro.',
  ...
  },
  {
    ...
    testo: 'Blocco 170: la prima volta che un bitcoin passa da una persona a un’altra. Il destinatario è Hal Finney, il crittografo che aveva costruito RPOW cinque anni prima e che era stato fra i primi a rispondere all’annuncio del white paper. Nei giorni precedenti aveva scaricato il programma e si era messo a far girare la rete.',
  ...
  },
  {
    ...
    testo: 'Un sito calcola il primo tasso di cambio partendo dal costo dell’elettricità necessaria a generarli: un dollaro vale 1.309 bitcoin. Detto al contrario, un bitcoin vale otto centesimi di centesimo di dollaro.',
  ...
  {
    id: 'consegna', breve: 'L’ultima email', anno: 2011, data: '23 aprile 2011', traccia: 'tronco', tipo: 'evento', cardine: true,
    titolo: 'L’ultima email', chi: 'Satoshi Nakamoto',
    testo: 'In un’email privata a uno degli sviluppatori, Satoshi scrive di essere passato ad altro e che il progetto è in buone mani con Gavin Andresen e gli altri. È l’ultima comunicazione considerata autentica. Il passaggio vero e proprio delle consegne — il sito, il codice, la chiave che permette di lanciare un allarme sulla rete — era avvenuto poco per volta nei mesi precedenti.',
    perche: 'Da qui in poi: silenzio. Nessun messaggio, nessuna email, nessuna moneta spostata.',
    fonte: { testo: 'L’archivio delle email di Satoshi', url: 'https://satoshi.nakamotoinstitute.org/emails/' }
  },
  {
    id: 'silenzio', breve: 'Il silenzio', anno: 2011, data: 'dal 2011', traccia: 'tronco', tipo: 'evento', finale: true,
    titolo: 'Il silenzio', chi: '',
    testo: 'Circa un milione di bitcoin risultano generati nei primi sedici mesi da un singolo computer, riconoscibile da una regolarità in un contatore interno ai blocchi che quella macchina faceva avanzare sempre allo stesso modo. Non si sono mai mossi. Non un trasferimento, non una prova, in oltre quindici anni. È la parte più difficile da spiegare di tutta questa storia: chiunque fosse, ha lasciato lì una fortuna e non l’ha toccata.',
...
const CANDIDATI = [
  {
    ...
    contro: 'Ha sempre negato. Nel 2014 un’analisi stilometrica commissionata da un giornalista trovò che il suo modo di scrivere era il più vicino a quello di Satoshi fra tutti i candidati esaminati — ma trovò anche che le email ricevute da Satoshi somigliavano al white paper più di quanto ci somigliasse la scrittura di Finney, il che lo scagionava. Si era ammalato di SLA nel 2009; è morto nel 2014.',
  ...
  },
  {
    ...
    a_favore: 'Fra le prime persone al mondo con cui Satoshi si sia scambiato email, prima ancora che il progetto fosse pubblico. Hashcash è una delle otto opere citate nel white paper.',
...
const CHIUSE = [
  {
    ...
    testo: 'Un settimanale americano identifica come inventore di Bitcoin un ingegnere californiano in pensione, che di nome fa davvero Satoshi Nakamoto, e ne pubblica l’indirizzo di casa. Lui nega tutto. Pochi giorni dopo, sul profilo attribuito a Satoshi compare una smentita di poche parole: non sono Dorian Nakamoto.'
  },
  {
    nome: 'Craig Wright', anno: '2016 – 2024',
    testo: 'Un informatico australiano sostiene per anni di essere Satoshi e porta in tribunale chi lo nega. Nel marzo 2024 l’Alta Corte di Londra stabilisce il contrario in termini definitivi: non ha creato Bitcoin, non ha scritto il white paper, e ha prodotto documenti falsi per sostenere la propria tesi.'
  }
];
