...
const TRACCE = [
  { id: 'chiave', nome: 'La chiave pubblica',   sintesi: 'Come scriversi in segreto senza essersi mai incontrati.' },
  { id: 'moneta', nome: 'La moneta anonima',    sintesi: 'Denaro digitale che non lascia il nome di chi paga.' },
  { id: 'tempo',  nome: 'La marca temporale',   sintesi: 'Dimostrare quando un documento è nato, senza notaio.' },
  { id: 'lavoro', nome: 'Il costo del lavoro',  sintesi: 'Rendere il falso costoso: la prova di lavoro.' },
  { id: 'codice', nome: 'Il codice è politica', sintesi: 'Chi scrive software decide chi può parlare in privato.' }
];
...
const NODI = [
  ...
  {
    id: 'diffie-hellman', anno: 1976, data: 'novembre 1976', traccia: 'chiave', tipo: 'idea',
  ...
  {
    id: 'rsa', anno: 1977, data: 'aprile 1977', traccia: 'chiave', tipo: 'idea',
  ...
  {
    id: 'merkle', anno: 1979, data: '1979', traccia: 'chiave', tipo: 'idea',
  ...
  {
    id: 'chaum-firme', anno: 1982, data: 'agosto 1982', traccia: 'moneta', tipo: 'idea',
  ...
  {
    id: 'digicash', anno: 1989, data: '1989', traccia: 'moneta', tipo: 'evento',
  ...
  {
    id: 'digicash-fine', anno: 1998, data: '1998', traccia: 'moneta', tipo: 'evento',
  ...
  {
    id: 'haber-stornetta', anno: 1991, data: '1991', traccia: 'tempo', tipo: 'idea',
  ...
  {
    id: 'surety', anno: 1995, data: 'dal 1995', traccia: 'tempo', tipo: 'evento',
  ...
  {
    id: 'hashcash', anno: 1997, data: 'marzo 1997', traccia: 'lavoro', tipo: 'idea',
  ...
  {
    id: 'b-money', anno: 1998, data: 'novembre 1998', traccia: 'lavoro', tipo: 'idea',
  ...
  {
    id: 'bit-gold', anno: 1998, data: '1998', traccia: 'lavoro', tipo: 'idea',
  ...
  {
    id: 'rpow', anno: 2004, data: 'agosto 2004', traccia: 'lavoro', tipo: 'idea',
  ...
  {
    id: 'pgp', anno: 1991, data: 'giugno 1991', traccia: 'codice', tipo: 'evento',
  ...
  {
    id: 'cypherpunk', anno: 1993, data: '9 marzo 1993', traccia: 'codice', tipo: 'evento',
  ...
  {
    id: 'crypto-wars', anno: 1993, data: '1993 – 2000', traccia: 'codice', tipo: 'evento',
  ...
  /* ── il tronco: Bitcoin ──────────────────────────────────────────── */
  {
    id: 'dominio', anno: 2008, data: '18 agosto 2008', traccia: 'tronco', tipo: 'evento',
  ...
  {
    id: 'lehman', anno: 2008, data: '15 settembre 2008', traccia: 'tronco', tipo: 'evento',
  ...
  {
    id: 'doppia-spesa', anno: 2008, data: 'il problema aperto', traccia: 'tronco', tipo: 'idea',
  ...
  {
    id: 'whitepaper', anno: 2008, data: '31 ottobre 2008, 14:10 UTC', traccia: 'tronco', tipo: 'evento', cardine: true,
  ...
  {
    id: 'genesi', anno: 2009, data: '3 gennaio 2009', traccia: 'tronco', tipo: 'evento', cardine: true,
  ...
  {
    id: 'v01', anno: 2009, data: '9 gennaio 2009', traccia: 'tronco', tipo: 'evento',
  ...
  {
    id: 'finney-tx', anno: 2009, data: '12 gennaio 2009, 03:30 UTC', traccia: 'tronco', tipo: 'evento', cardine: true,
  ...
  {
    id: 'cambio', anno: 2009, data: '5 ottobre 2009', traccia: 'tronco', tipo: 'evento',
  ...
  {
    id: 'pizza', anno: 2010, data: '22 maggio 2010', traccia: 'tronco', tipo: 'evento',
  ...
  {
    id: 'ultimo-post', anno: 2010, data: '12 dicembre 2010', traccia: 'tronco', tipo: 'evento', cardine: true,
  ...
  {
    id: 'consegna', anno: 2011, data: '26 aprile 2011', traccia: 'tronco', tipo: 'evento', cardine: true,
  ...
  {
    id: 'silenzio', anno: 2011, data: 'dal 2011', traccia: 'tronco', tipo: 'evento', finale: true,
